...
input_onnx_model = r'D:\Project\SSL-pretraining-separation-main\result\test_onnx\test.onnx'
# Change this path to the output name and path for your float16 ONNX model
output_onnx_model = r'D:\Project\SSL-pretraining-separation-main\result\test_onnx\test_f16.onnx'
# Load your model
